...
const fiveguysBurger = "/images/hero-burger.jpg";
const littleHamburger = "/images/little-hamburger.jpg";
const baconCheeseburger = "/images/bacon-cheeseburger.jpg";
const fries = "/images/fries.jpg";
const cajunFries = "/images/cajun-fries.jpg";
const hotDog = "/images/hot-dog.jpg";
const baconDog = "/images/bacon-dog.jpg";
