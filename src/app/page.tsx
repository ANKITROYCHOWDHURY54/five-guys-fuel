...
const heroBurger = "/images/hero-burger.jpg";
const fiveguysBurger = "/images/bacon-cheeseburger.jpg";
const fries = "/images/fries.jpg";
const milkshake = "/images/milkshake.jpg";
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card className="overflow-hidden hover:shadow-lg transition-shadow">
              <div className="aspect-video bg-muted">
                <Image src={fiveguysBurger} alt="Five Guys Burger" className="w-full h-full object-cover" width={400} height={300} />
              </div>
            ...
            <Card className="overflow-hidden hover:shadow-lg transition-shadow">
              <div className="aspect-video bg-muted">
                <Image src={fries} alt="Five Guys Fries" className="w-full h-full object-cover" width={400} height={300} />
              </div>
              <CardContent className="p-6">
            ...
            <Card className="overflow-hidden hover:shadow-lg transition-shadow">
              <div className="aspect-video bg-muted">
                <Image src={milkshake} alt="Five Guys Milkshake" className="w-full h-full object-cover" width={400} height={300} />
              </div>
              <CardContent className="p-6">
